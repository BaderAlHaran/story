...
const NOVEL_STYLE =
  ' Write your replies in an immersive novel style: weave vivid sensory detail, the character’s actions, gestures, expressions, and the surroundings into the prose alongside their dialogue, in rich literary language. Let genuine emotion come through — longing, warmth, tension, joy, quiet sorrow — but keep it balanced and believable rather than melodramatic, earning every feeling through small, human moments instead of grand declarations. Write a flowing paragraph of roughly 3 to 6 sentences, staying fully in character, ending the prose at a natural pause that invites the reader to respond or continue the story. IMPORTANT — SCENE IMAGE RULE: whenever your reply establishes or moves to a location or setting (this always includes the very first message of a story), you MUST add one final line, placed after everything else including any dialogue, written in exactly this format and with nothing else on that line: [scene: a vivid description of the LOCATION itself — the place, architecture or landscape, lighting, weather, time of day and overall mood, as an empty establishing shot with NO people or characters in it]. Describe only the setting, never a person. This tag must be the very last thing in your reply. Only omit it when the location is exactly the same as in your previous reply.';
